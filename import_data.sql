...
INSERT INTO product_variants (
    ...
    'Leadbelcher', 'Leadbelcher', 'prod4540241-13209999111', ARRAY['Silver'], ARRAY['Spray'], 'Opaque', 'Low', FALSE, '/app/resources/catalog/product/920x950/99209999051_sprayLeadbelcher.svg', 'SprayCan', 295.735, 10.0, 2400, 'USD', '$', 'US', 'https://www.warhammer.com/en-US/shop/Leadbelcher-Spray-US-2020', 'en', 'Citadel', 'Primer', '5ba77422-91cb-46dd-98d1-c108588cf6b6',
...
INSERT INTO product_variants (
    ...
    'Leadbelcher', 'Leadbelcher', 'prod4210283-99189950235', ARRAY['Silver'], ARRAY['Base'], 'Opaque', 'MediumHigh', FALSE, '/app/resources/catalog/product/920x950/99189950028_baseLeadbelcher.svg', 'Pot', 18.0, 0.609, 455, 'USD', '$', 'US', 'https://www.warhammer.com/en-US/shop/Leadbelcher-Spray-US-2020', 'en', 'Citadel', NULL, '7e65291e-5930-41aa-b1a6-e16e069b80f3',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id
     WHERE p.name = 'Leadbelcher'
     AND pl.slug = 'citadel')
...
INSERT INTO product_variants (
    ...
    'Leadbelcher', 'Leadbelcher', 'prod4190214-99189958146', ARRAY['Silver'], ARRAY['Air'], 'SemiOpaque', 'Low', FALSE, '/app/resources/catalog/product/920x950/99189958068_airLeadbelcher.svg', 'Pot', 18.0, 0.609, 780, 'USD', '$', 'US', 'https://www.warhammer.com/en-US/shop/Leadbelcher-Spray-US-2020', 'en', 'Citadel', 'Air', '70947164-52f3-4a2b-9651-4d4c2d5bafbf',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id
     WHERE p.name = 'Leadbelcher'
     AND pl.slug = 'citadel')
...
INSERT INTO product_variants (
    ...
    'Wraithbone', 'Wraithbone', 'prod4540239-13209999105', ARRAY['Bone'], ARRAY['Spray'], 'Opaque', 'Low', FALSE, '/app/resources/catalog/product/920x950/99209999059_sprayWraithBone.svg', 'SprayCan', 295.735, 10.0, 2400, 'USD', '$', 'US', 'https://www.warhammer.com/en-US/shop/Wraithbone-Spray-US-2020', 'en', 'Citadel', 'Primer', '1d0f1240-cabc-48b5-ac7b-7388b38f0541',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id
...
INSERT INTO product_variants (
    ...
    'Wraithbone', 'Wraithbone', 'prod4190166-99189950259', ARRAY['Bone'], ARRAY['Base'], 'Opaque', 'MediumHigh', FALSE, '/app/resources/catalog/product/920x950/99189950173_baseWraithBone.svg', 'Pot', 18.0, 0.609, 455, 'USD', '$', 'US', 'https://www.warhammer.com/en-US/shop/Wraithbone-Spray-US-2020', 'en', 'Citadel', NULL, '3d6d8832-f9c9-4092-aecd-77dba3ddb94e',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id
     WHERE p.name = 'Wraithbone'
     AND pl.slug = 'citadel')
...
INSERT INTO product_variants (
    ...
    'Grey Seer', 'Grey Seer', 'prod4540238-13209999106', ARRAY['Grey'], ARRAY['Spray'], 'Opaque', 'Low', FALSE, '/app/resources/catalog/product/920x950/99209999060_sprayGreySeer.svg', 'SprayCan', 295.735, 10.0, 2400, 'USD', '$', 'US', 'https://www.warhammer.com/en-US/shop/Grey-Seer-Spray-US-2020', 'en', 'Citadel', 'Primer', '0612cf8a-05b9-4e7c-b935-4e403a890dec',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id
...
INSERT INTO product_variants (
    ...
    'Grey Seer', 'Grey Seer', 'prod4190167-99189950260', ARRAY['Grey'], ARRAY['Base'], 'Opaque', 'MediumHigh', FALSE, '/app/resources/catalog/product/920x950/99189950174_baseGreySeer.svg', 'Pot', 18.0, 0.609, 455, 'USD', '$', 'US', 'https://www.warhammer.com/en-US/shop/Grey-Seer-Spray-US-2020', 'en', 'Citadel', NULL, 'afed8b1f-4f25-416b-b9fd-0845e75771aa',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id
     WHERE p.name = 'Grey Seer'
     AND pl.slug = 'citadel')
...
INSERT INTO product_variants (
    ...
    'Matt Black', 'Warpaints Fanatic: Matt Black', 'WP3001P', ARRAY['White/Grey/Black'], ARRAY['Acrylics'], 'SemiOpaque', 'Medium', NULL, 'https://cdn.shopify.com/s/files/1/0636/1232/1970/files/WP3001-MattBlack-Acrylics-1copy_7ebcd050-502a-4194-a54d-d1153f90bd7c.jpg?v=1712751313', 'DropperBottle', 18.0, 0.609, 425, 'USD', '$', 'US', 'https://us.thearmypainter.com/products/warpaints-fanatic-matt-black', 'en', 'Warpaints Fanatic', NULL, '7891271778482',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id
...
INSERT INTO product_variants (
    ...
    'Deep Grey', 'Warpaints Fanatic: Deep Grey', 'WP3002P', ARRAY['White/Grey/Black'], ARRAY['Acrylics'], 'SemiOpaque', 'Medium', NULL, 'https://cdn.shopify.com/s/files/1/0636/1232/1970/files/WP3002-DeepGrey-Acrylics-1copy_77dd3c3d-8b8c-45c6-a8b0-e93a0e90b952.jpg?v=1712751313', 'DropperBottle', 18.0, 0.609, 425, 'USD', '$', 'US', 'https://us.thearmypainter.com/products/warpaints-fanatic-deep-grey', 'en', 'Warpaints Fanatic', NULL, '7891277545650',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id
...
INSERT INTO product_variants (
    ...
    'Goddess Glow', 'Speedpaint: Goddess Glow', 'WP2038P', ARRAY['Skin Tone'], NULL, 'SemiTransparent', 'Low', NULL, 'https://cdn.shopify.com/s/files/1/0636/1232/1970/files/WP2038-GoddessGlow-img1_73e39958-ea97-45f9-9644-281d8b5da06b.jpg?v=1708413637', 'DropperBottle', 18.0, 0.609, 499, 'USD', '$', 'US', 'https://us.thearmypainter.com/products/speedpaint-goddess-glow', NULL, 'Speedpaint', NULL, '7891279347890',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id
...
INSERT INTO product_variants (
    ...
    'Bony Matter', 'Speedpaint: Bony Matter', 'WP2039P', ARRAY['Brown'], NULL, 'SemiTransparent', 'Low', NULL, 'https://cdn.shopify.com/s/files/1/0636/1232/1970/files/WP2039-BonyMatter-img1_0786c1ae-0c83-49d7-9dd2-831dde236fac.jpg?v=1708413657', 'DropperBottle', 18.0, 0.609, 499, 'USD', '$', 'US', 'https://us.thearmypainter.com/products/speedpaint-bony-matter', NULL, 'Speedpaint', NULL, '7891277447346',
    (SELECT p.id FROM products p
     JOIN product_lines pl ON p.product_line_id = pl.id

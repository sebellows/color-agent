...
# from app.core.utils.api_filter import Filter
...
class CRUDAdapter(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    """
    ...
    * `schema`: A Pydantic model (schema) class
    ...
    async def get_paginated(self, db: AsyncSession, query_filter=None) -> Page:
        return await paginate(db, self._get(query_filter))  # type: ignore

...
from ..exceptions import InvalidModelError, UnmappedPropertyError
from ..models.base import ModelT
from ..schemas.base import CursorReference
...
class BaseRepository(Generic[ModelT], ABC):
    ...
    def __init__(self, model_class: Union[Type[ModelT], None] = None) -> None:
    ...
    def _is_mapped_class(self, class_: Type[ModelT]) -> bool:
        """
        Checks if the class is mapped in SQLAlchemy.

        PARAMS:
        -------
            class_: the model class
    ...
    def _validate_mapped_property(self, property_name: str) -> None:
        ...
        PARAMS:
        --------
            property_name: The name of the property to be evaluated.

        RAISES:
        -------
            UnmappedPropertyError: When the property is not mapped.
        """
    ...
    def _filter_select(self, stmt: Select, search_params: Mapping[str, Any]) -> Select:
        ...
        -------
            ...
            search_params: Any keyword argument to be used as equality filter
    ...
    def _filter_order_by(
        ...
        -------
            stmt: a Select statement
            order_by: a list of columns, or tuples (column, direction)
    ...
    def _cursor_paginated_query(
        ...
        -------
            stmt: a Select statement
            cursor_reference: A cursor reference containing ordering column
                and threshold value
            is_before_cursor: If True it will return items before the cursor,
    ...
    def _fail_if_invalid_models(self, objects: Iterable[ModelT]) -> None:

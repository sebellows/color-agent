...
@router.delete(
    "/product-types/{product_type_id}", status_code=status.HTTP_204_NO_CONTENT
)
...
@router.delete("/color-ranges/{color_range_id}", status_code=status.HTTP_204_NO_CONTENT)
...
# Analogous routes
@router.post(
    "/analogous/", response_model=AnalogousSchema, status_code=status.HTTP_201_CREATED
)
...
@router.delete("/analogous/{analogous_id}", status_code=status.HTTP_204_NO_CONTENT)

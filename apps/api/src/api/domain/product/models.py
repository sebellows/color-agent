...
class Product(Entity, WithFullTimeAuditMixin, WithUniqueSlugMixin):
    ...
    tags: Mapped[list["Tag"]] = relationship("Tag", secondary=product_tag_association, back_populates="products")
    analogous: Mapped[list["Analogous"]] = relationship(
        "Analogous", secondary=product_analogous_association, back_populates="products"
    )

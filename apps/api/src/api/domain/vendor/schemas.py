...
class VendorUpdate(BaseModel):
    ...
    pdp_slug: Annotated[str | None, Field(description="Product detail page slug")] = None
    plp_slug: Annotated[str | None, Field(description="Product listing page slug")] = None

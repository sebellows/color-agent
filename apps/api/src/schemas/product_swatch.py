...
class ProductSwatchUpdate(BaseModel):
    ...
    oklch_color: Annotated[
        list[float] | None, Field(description="OKLCH color values")
    ] = None
    gradient_start: Annotated[
        list[float] | None, Field(description="Gradient start color values")
    ] = None
    gradient_end: Annotated[
        list[float] | None, Field(description="Gradient end color values")
    ] = None
    overlay: Annotated[OverlayEnum | None, Field(description="Overlay effect")] = None

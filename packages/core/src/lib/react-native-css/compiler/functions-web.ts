...
export function platformSelect(specifics: Partial<Record<PlatformOSType | 'default', unknown>>) {
    return specifics['web'] ?? specifics['default']
}

export function pixelScaleSelect(specifics: Partial<Record<number | 'default', unknown>>) {
    return specifics[1] ?? specifics['default']
}

export function fontScaleSelect(specifics: Partial<Record<number | 'default', unknown>>) {
    return specifics[1] ?? specifics['default']
}

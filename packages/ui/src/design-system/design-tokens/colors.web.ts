...
type ColorSchemes = Pick<Colors, 'light' | 'dark'>
...
type ColorVariants = Omit<Colors, ColorScheme>
...
export type ColorToken = ColorSchemeToken | `${ColorVariant}.${ColorVariantToken}`

import { PALETTE_COLOR_NAMES, THEME_COLOR_SCHEMES } from '../../theme/theme.const'
...
export type StateColor = 'default' | 'focus' | 'hover' | 'active' | 'disabled' | 'invalid' | 'valid'
export type ThemeStateColors = Record<StateColor, keyof PaletteColors>

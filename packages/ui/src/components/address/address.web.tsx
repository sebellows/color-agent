...
export type AddressDisplayerProps = AddressBaseProps & BoxProps
...
export function Address({
    ...
    const LabelElement = tag === 'dl' ? 'dt' : 'span'
    const ValueElement = tag === 'dl' ? 'dd' : 'span'
    ...
    return (
        <Wrapper style={{ display: 'flex', flexDirection: 'column', ...props }}>

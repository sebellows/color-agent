...
export type PropsWithRef<C, P> = { ref?: React.Ref<C> } & P

const Pressable = ({ ref, ...props }: PropsWithRef<typeof RNPressable, RNPressableProps>) => {
...
const View = ({ ref, ...props }: PropsWithRef<typeof RNView, RNViewProps>) => {
...
const Text = ({ ref, ...props }: PropsWithRef<typeof RNText, RNTextProps>) => {
...
const Image = ({ ref, ...props }: PropsWithRef<RNImage, ImageSlotProps>) => {

...
import { idle, useAsyncEffect } from '../../hooks/use-async-effect'
import { useEvent } from '../../hooks/use-event'
import { useComposedRefs } from '../../lib/compose-refs'
import { startTransition } from '../../lib/start-transition'
import { useFocusScopeControllerContext } from './focus-scope.controller'
import { FocusScopeProps, ScopedProps } from './focus-scope.types'
 ...
 * @component FocusScope
 * @description
 * Allows managing keyboard focus behavior within container elements accessibly. Controls focus
 * trapping, auto-focus behavior, and focus cycling for accessible interactive components.
 ****************************************************************************************************/

const FocusScope = React.forwardRef<FocusScopeElement, FocusScopeProps>(function FocusScope(
    ...
    return React.cloneElement(React.Children.only(mergedProps.children) as any, childProps)
})

...
Root.displayName = 'AccordionRoot.Web'
...
const Item = ({ ref, asChild, value: itemValue, disabled, ...props }: ItemProps) => {
...
Item.displayName = 'AccordionItem.Web'
...
const Header = ({ ref, asChild, ...props }: HeaderProps) => {
    const augmentedRef = useAugmentedRef({ ref })
...
Header.displayName = 'AccordionHeader.Web'
...
const Trigger = ({ ref, asChild, disabled: disabledProp, ...props }: TriggerProps) => {
...
Trigger.displayName = 'AccordionTrigger.Web'
...
Content.displayName = 'AccordionContent.Web'

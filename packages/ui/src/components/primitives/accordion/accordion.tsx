...
Root.displayName = 'AccordionRoot.Native'
...
const Item = ({ ref, asChild, value, disabled, ...viewProps }: ItemProps) => {
...
Item.displayName = 'AccordionItem.Native'
...
Header.displayName = 'AccordionHeader.Native'
...
Trigger.displayName = 'AccordionTrigger.Native'
...
Content.displayName = 'AccordionContent.Native'

...
Root.displayName = 'HoverCardRoot.Native'
...
Trigger.displayName = 'HoverCardTrigger.Native'

/**
 * @warning when using a custom `<PortalHost />`, you might have to adjust the Content's
 * sideOffset to account for nav elements like headers.
 */
function Portal({ forceMount, hostName, children }: PortalProps) {
    const value = useRootContext()

    if (!value.triggerPosition || (!forceMount && !value.open)) {
        return null
    }
...
Overlay.displayName = 'HoverCardOverlay.Native'
...
Content.displayName = 'HoverCardContent.Native'
